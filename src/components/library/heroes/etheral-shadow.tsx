/**
 * EtheralShadow — SVG filter-gebaseerde vloeiende schaduw-animatie
 *
 * Bron: 21st.dev
 * Type: Hero background / decoratief overlay
 * Stijl: Organisch, vloeiend, mysterieus
 * Wanneer gebruiken: Creatieve/artistieke bedrijven, wellness, premium gevoel
 * Past bij niches: Kappers, schoonheidssalons, coaches, therapeuten
 * Niet geschikt voor: Zakelijke/corporate niches
 *
 * Dependencies: framer-motion
 * Props: color (rgba), animation {scale, speed}, noise {opacity, scale}, sizing, className
 */
'use client';
